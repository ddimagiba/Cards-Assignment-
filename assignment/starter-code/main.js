...
firstCard, that one gets rthe value of the card that has been clicked.
...
$('cards').shuffle(funtion(){
  $('div').innerText('cards')
  var $cards = $('<div>').innerText(cards)
}

$shuffledCards = $('<div>').text(cards)
  $('<div>').text(firstCard)appendTo(#board)
  $('<div>').text(secondCard)appendTo(#board)
$cards.appendTo('#board')
